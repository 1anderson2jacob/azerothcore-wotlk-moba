...
| Towers | `Zones/MobaTowerData.{h,cpp}`, `scripts/Custom/npc_moba_tower.cpp` + `moba_tower_aggro.cpp` | `tower_config.json` → `gen_tower_data.py` → `mod_moba_towers.sql`; creature defs hand-written in `mod_moba_tower_defs.sql` |
