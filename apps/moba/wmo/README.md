...
| 6 | WDT + DBC rows, MPQ patch, run the extractors | **no** |

Steps 1–5 below are a procedure that has been run start to finish. Step 6 has
...
materials wired to texture paths, and a test doodad.
...
the 5.1 file backed up instead.
...
WDT with the global-map-object flag, DBC rows, MPQ packing, then
...
|---|---|---|
| `blender_staging_setup.py` | Blender 3.4 Text Editor | yes, 2026-08-12 |
